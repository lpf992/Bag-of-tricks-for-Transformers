...
# trick: inline SOAP class (no algorithm changes from upstream).
...
def main() -> None:
    ...
    # trick: optimizer list now contains SOAP instead of Muon for matrix params.
    optimizers: list[torch.optim.Optimizer] = [optimizer_tok, optimizer_soap, optimizer_scalar]
    ...
    # trick: log SOAP config (replaces Muon for matrix params).
    log0(
            ...
            wandb_log(
                {
                    ...
                    # trick: SOAP has no momentum schedule; train/muon_momentum removed; train/lr_matrix renamed.
                    ...
                    "train/lr_soap": float(optimizer_soap.param_groups[0]["lr"]),
